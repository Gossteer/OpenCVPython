...
https://scikit-image.org/docs/dev/auto_examples/applications/plot_image_comparison.html#sphx-glr-download-auto-examples-applications-plot-image-comparison-py
